...
module.exports = {
	...
	attributes: {
		...
		curso: {
			//se usa esta propiedad para poder retornar los puntos y medallas en cada curso, sin tener que buscar por submodulo
			type: "string",
			required: true
		},
		...
		//
		estudiante: {
			//el intento pertenece al estudiante, relacion: un estudiante tiene varios intentos
			model: "Estudiante",
			required: true
		},
		submodulo: {
			//la evaluacion esta dentro del modelo Submodulo, por tanto se asocia directamente con el Submodulo, relacion un submodulo tiene varios intentos
