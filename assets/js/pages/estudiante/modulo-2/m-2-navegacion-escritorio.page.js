parasails.registerPage("m-2-navegacion-escritorio", {
	...
	data: {
		...
		escritorio: {
			...
			detalle:
				"El escritorio vacío es la parte del escritorio que no ha sido usada por un icono o acceso directo, la imágen que se ve al fondo se llama FONDO DE ESCRITORIO",
			leerMas:
