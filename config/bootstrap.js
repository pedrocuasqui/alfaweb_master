...
module.exports.bootstrap = async function (done) {
  ...
  if (await Estudiante.count() == 0 && Object.keys(curso).length > 0) {
    ...
    var mod1Bdd = await ModuloLibro.create({
      ...
      multimedia: { imagen: 'http://localhost:1337/images/uploaded/01a99446-f666-4b78-9e2d-a25c727fdb86.jpg' },
      curso: cursoBdd.id,
    ...
    var submoduloModulo2Bdd = await SubmoduloLibro.create({
      ...
      contenidoTiny: '<p style="text-align: justify;">A fin de evitar que id&eacute;ntios datos se encuentren repetidos en m&uacute;ltiples archivos, parece necesario que los comunes se almacenen en un archivo &uacute;nico y que este archivo sea accesible por todos los programas que los manipulen.</p><p style="text-align: left;"><strong>Definici&oacute;n</strong></p><p style="text-align: justify;">Una base de datos es una colecci&oacute;n de datos interrelacionados, almacenados en un conjunto sin redundancias (repeticiones) perjudiciales o in<span style="font-family: helvetica, arial, sans-serif;">necesarias. Su finalidad es la de servir a una o m&aacute;s aplicaciones de la mejor manera posible. Los datos se almacenan de modo que resulten independientes de los programas que los utilizan, y se emplean m&eacute;todos concretos y determinados para incluir nuev</span>os datos y para modificar o extraer los ya almacenados.</p><p><img style="display: block; margin-left: auto; margin-right: auto;" src="https://jordilopez94.files.wordpress.com/2014/09/sistemas-gestores-base-datos.jpg" alt="" width="108" height="86" /></p><p style="text-align: left;"><strong>Gestores de bases de datos relacionales</strong></p><p style="text-align: left;"><strong>SQL Server:&nbsp;&nbsp;</strong><span style="color: #222222; font-family: helvetica, arial, sans-serif; font-size: 12pt;">Microsoft SQL Server es un sistema de gesti&oacute;n de base de datos relacional, desarrollado por la empresa Microsoft. El lenguaje de desarrollo utilizado es Transact-SQL</span></p><p style="text-align: left;"><span style="color: #222222; font-family: helvetica, arial, sans-serif; font-size: 12pt;"><img style="display: block; margin-left: auto; margin-right: auto;" src="http://www.ingdiaz.org/wp-content/uploads/2018/01/j00-150x150.png" alt="" width="87" height="87" /></span></p><p style="text-align: left;"><span style="color: #222222; font-family: helvetica, arial, sans-serif; font-size: 12pt;">MySQL:&nbsp;</span><strong style="color: #222222; font-family: sans-serif; font-size: 14px;">MySQL</strong><span style="color: #222222; font-family: sans-serif; font-size: 14px;">&nbsp;es un&nbsp;</span><a style="color: #0b0080; background: none #ffffff; font-family: sans-serif; font-size: 14px;" title="Sistema de gesti&oacute;n de bases de datos" href="https://es.wikipedia.org/wiki/Sistema_de_gesti%C3%B3n_de_bases_de_datos">sistema de gesti&oacute;n de bases de datos</a><span style="color: #222222; font-family: sans-serif; font-size: 14px;">&nbsp;</span><a style="color: #0b0080; background: none #ffffff; font-family: sans-serif; font-size: 14px;" title="Modelo relacional" href="https://es.wikipedia.org/wiki/Modelo_relacional">relacional</a><span style="color: #222222; font-family: sans-serif; font-size: 14px;">&nbsp;desarrollado bajo licencia dual:&nbsp;</span><a class="mw-redirect" style="color: #0b0080; background: none #ffffff; font-family: sans-serif; font-size: 14px;" title="Licencia P&uacute;blica General" href="https://es.wikipedia.org/wiki/Licencia_P%C3%BAblica_General">Licencia p&uacute;blica general</a><span style="color: #222222; font-family: sans-serif; font-size: 14px;">/</span><a style="color: #0b0080; background: none #ffffff; font-family: sans-serif; font-size: 14px;" title="" href="https://es.wikipedia.org/wiki/Software_propietario">Licencia comercial</a><span style="color: #222222; font-family: sans-serif; font-size: 14px;">&nbsp;por&nbsp;</span><a style="color: #0b0080; background: none #ffffff; font-family: sans-serif; font-size: 14px;" title="Oracle Corporation" href="https://es.wikipedia.org/wiki/Oracle_Corporation">Oracle Corporation</a><span style="color: #222222; font-family: sans-serif; font-size: 14px;">&nbsp;y est&aacute; considerada como la base datos de&nbsp;</span><a class="mw-redirect" style="color: #0b0080; background: none #ffffff; font-family: sans-serif; font-size: 14px;" title="Open source" href="https://es.wikipedia.org/wiki/Open_source">c&oacute;digo abierto</a><span style="color: #222222; font-family: sans-serif; font-size: 14px;">&nbsp;m&aacute;s popular del mundo,</span><sup id="cite_ref-1" class="reference separada" style="line-height: 1em; unicode-bidi: isolate; white-space: nowrap; margin-right: 0.6ch; color: #222222; font-family: sans-serif;"></sup><span style="color: #222222; font-family: sans-serif; font-size: 14px;">&nbsp;y una de las m&aacute;s populares en general junto a&nbsp;</span><a style="color: #0b0080; background: none #ffffff; font-family: sans-serif; font-size: 14px;" title="Oracle Database" href="https://es.wikipedia.org/wiki/Oracle_Database">Oracle</a><span style="color: #222222; font-family: sans-serif; font-size: 14px;">&nbsp;y&nbsp;</span><a style="color: #0b0080; background: none #ffffff; font-family: sans-serif; font-size: 14px;" title="Microsoft SQL Server" href="https://es.wikipedia.org/wiki/Microsoft_SQL_Server">Microsoft SQL Server</a><span style="color: #222222; font-family: sans-serif; font-size: 14px;">, sobre todo para entornos de&nbsp;</span><a style="color: #0b0080; background: none #ffffff; font-family: sans-serif; font-size: 14px;" title="Desarrollo web" href="https://es.wikipedia.org/wiki/Desarrollo_web">desarrollo web</a><span style="color: #222222; font-family: sans-serif; font-size: 14px;">.</span></p><p style="text-align: left;"><span style="color: #222222; font-family: sans-serif; font-size: 14px;"><img style="display: block; margin-left: auto; margin-right: auto;" src="https://www.frikipandi.com/wp-content/uploads/2015/03/MySQL.jpg" alt="" width="207" height="130" /></span></p><p style="text-align: left;">&nbsp;</p>',
      color: "#b642e1",
      enlace: "",
      ordenNavegacion: 0,
      evaluacion: {
