...
module.exports = {
    ...
    friendlyName: 'Cargar Contenido del curso el contenido del curso desde la base de datos',
  
  
    description: 'Realiza la consulta a la base de datos y retorna el contenido del curso   ',
