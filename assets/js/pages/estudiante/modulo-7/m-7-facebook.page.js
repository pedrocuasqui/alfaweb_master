parasails.registerPage('m-7-facebook', {
  ...
  data: {
    ...
    facebook: {
      ...
      detalle: 'Página web donde se puede compartir información con otras personas; generalmente, amigos o familiares. Se comparte mensajes de texto, enlaces, álbumes de fotos, vídeos, etc. También es posible comentar e interactuar con las publicaciones de tus amigos.',
      leerMas:'',
      imgs: [
  
        {
          src: 'https://www.tecnologia.net/wp-content/uploads/2017/05/gif-animados-facebook-downloader.gif',
          alt: 'Facebook',
        },
    ...
    paso1: {
      ...
      detalle: 'Lo primero, abrir la página principal de Facebook en un navegador: www.facebook.com. Rellenar todos los datos y dar clic en Regístrate para pasar al segundo paso.',
      leerMas:'',
      imgs: [
    ...
    paso2: {
      ...
      detalle: '¿Recuerdas que la cuenta de correo era importante? Ahora sabrás por qué. Facebook ha mandado un correo a tu dirección para comprobar que efectivamente te pertenece. Hasta que no lo hagas, algunas funciones no estarán disponibles.',
      leerMas:'',
      imgs: [
    ...
    paso3: {
      ...
      detalle: 'Ingresar el correo electrónico de la persona a buscar en la siguiente interfaz, y dar clic en Buscar amigos.',
      leerMas:'',
      imgs: [
    ...
    paso4: {
      ...
      detalle: 'En el siguiente paso se puede revisar un poco más sobre Quién ve lo que se comparte en Facebook.      Esta información servirá para encontrar antiguos compañeros de clase o gente con la que se ha trabajado. En cualquier caso, es opcional. Dar clic en Guardar y continuar para ir al siguiente paso.      ',
      leerMas:'',
      imgs: [
    ...
    paso6: {
      ...
      detalle: 'Ingresar el nombre o el correo electrónico del amigo o persona que se quieres agregarle a tu lista de amigos. ',
      leerMas:'',
      imgs: [
    ...
    paso7: {
      ...
      detalle: 'Clic en tu nombre, en este caso es Prueba. Completa los datos para que Facebook pueda encontrar a personas de la misma Ciudad, Trabajo o Lugar de Estudios que quizá conoces.',
      leerMas:'',
      imgs: [
