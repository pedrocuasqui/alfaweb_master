  ...
  data:{
    breadcrumb: [],
      ...
      ortografia: {
        ...
        html:''+
        '<p>Al hacer clic sobre Ortografía y gramática aparecerá la siguiente pantalla.</p>'+
        '<img src="/images/word/p_revisar/1.png" alt="Opciones de ortografía">'+
       ' <p>Esta interfaz permite paso a paso revisar las faltas ortográficas del documento.</p>'+
      '  <p>Dar clic derecho sobre la palabra subrayada en rojo o verde, se mostrará diferentes opciones de escritura correcta.</p>'+
        '<img src="/images/word/p_revisar/2.png" alt="Opciones para corregir la palabra">'+
        '<p>Finalmente, los errores ortográficos se encuentran corregidos.</p>'+
        '<img src="/images/word/p_revisar/3.png" alt="Errores Corregidos">'
      },
