parasails.registerPage('m-1-hardware', {
  ...
  data: {
    ...
    mouse: {
      ...
      imgs: [{
        src: 'https://product-images.www8-hp.com/digmedialib/prodimg/lowres/c03330229.png',
        alt: 'Mouse'
      }],
    ...
    impresora: {
      id: 'Impresora',
      titulo: 'Impresora',
      detalle: 'La impresora es un objeto auxiliar, que está conectado a una unidad central de procesamiento de una computadora, su función es hacer hacer una copia de aquellos documentos que han sido almacenados en un formato electrónico. Estos documentos pueden ser textos o imágenes que son impresos en una hoja o transparencia utilizando cartuchos de tintas o tecnología láser. Vea el siguiente video que muestra como sacar una copia usando una impresora epson',
      leerMas: 'https://conceptodefinicion.de/impresora/',
      html: '<iframe width="560" height="315" src="https://www.youtube.com/embed/QKIOlpO4j9c?start=87" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',

    },
    usb: {
      id: 'Usb',
      titulo: 'Pendrive o Flash memory',
      detalle: ' Es un tipo de dispositivo de almacenamiento de datos que utiliza circuitos de estado sólido para guardar datos e información. En la imágen se puede ver varios pendrives de diferentes formas y capacidades de almacenamiento',
      leerMas: 'https://es.wikipedia.org/wiki/Memoria_USB',
      imgs: [{
        src: 'https://userscontent2.emaze.com/images/1396c703-d396-4136-a1a2-080acfff0b48/2b9cad36-bcd9-4445-8e3b-1d85112da0d7image3.jpeg',
